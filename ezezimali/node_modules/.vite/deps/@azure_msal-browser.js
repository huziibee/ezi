import {
  ...
  version
} from "./chunk-JP2G27FE.js";
import {
  BridgeStatusCode
} from "./chunk-5UQQW2NS.js";
import {
  AccountEntity,
  ApiId,
  AuthError,
  ...
  WrapperSKU,
  createNewGuid
} from "./chunk-D6CAEU4L.js";
import {
  BrowserPerformanceMeasurement
} from "./chunk-ZGAVZVE2.js";
...
async function createV3Controller(config) {
  ...
  const controller = await import("./StandardController-ICWOXQVU.js");
...
async function createController(config) {
  ...
  if (teamsApp.isAvailable() && teamsApp.getConfig().auth.supportsNestedAppAuth) {
    const controller = await import("./NestedAppAuthController-AFJHZYIF.js");
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-YZJ6RNMY.js");
    }
  } catch (e) {
  }
  return void 0;
